...
inv(a::UnitDual) =  UnitDual(inv(a), scale_partials(partials(a), -1/value(a)^2))
...
isequal(a::UnitDual, b::UnitDual) = isequal(value(a), value(b)) && isequal(partials(a), partials(b))
isequal(a::UnitDual, b::Number) = isequal(value(a), b)
isequal(a::Number, b::UnitDual) = isequal(b, a)
